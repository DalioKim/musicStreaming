  ...
  <script type="text/javascript">
      ...
      function handleImgFileSelect(e) {
          ...
          filesArr.forEach(function(f) {
              ...
              reader.onload = function(e) {
                  ...
                  //var html = "<a href=\"javascript:void(0);\" onclick=\"deleteImageAction("+index+")\" id=\"img_id_"+index+"\"><img src=\"" + e.target.result+ "\" data-file='"+f.name+"' class='selProductFile' title='이미지를 클릭하시면 삭제가 됩니다.'><img src= images/x_button.png></a>";
                  var html = "<a href=\"javascript:void(0);\" onclick=\"deleteImageAction("+index+")\" id=\"img_id_"+index+"\" onmouseenter=\"add()\"><img src=\"" + e.target.result+ "\" data-file='"+f.name+"' class='selProductFile' title='Click to remove'></a>";
      ...
      function deleteImageAction(index) {
          ...
          sel_files.forEach(function() {
            ...
            var html = "<a class =\"focus;\" href=\"javascript:void(0);\" onclick=\"deleteImageAction("+index+")\" id=\"img_id_"+index+"\"><img src=\"" + sel_files[index].url+ "\" data-file='"+sel_files[index].name+"' class='selProductFile' title='이미지를 클릭하시면 삭제가 됩니다.'></a>";
          $(".imgs_wrap").append(html);
          index++;
      ...
      function add() {
        console.log("커서이벤트");
        $(".selProductFile").attr("src","/images/x_button.png");
      }
...
<div class="jumbotron">
  <div class="container">
    <form class="form-horizontal" action=intermediate.php >
