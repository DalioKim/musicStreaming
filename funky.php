...
<style>
    ...
    .jumbotron {
      background-image: url("images/daftpunk.jpg");
         ...
         <div class="container">
           <div class="jumbotron mt-3">
              <h1 class="text-center">Music to GoodTrip</h1>
               <p class="text-center">MtG와 떠나는 펑키여행</p>
             </div>
           </div>
...
// 장르별 데이터의 총 갯수를 세주는 부분
  ...
  $sql = mysqli_query($db, "SELECT * FROM music where genre='funky' ");
...
$mql = mysqli_query($db, "SELECT * FROM music where genre='funky' order by recommend desc, title asc limit 0, 5");
